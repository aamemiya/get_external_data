...
grads="/apps/SLES11/opt/grads/2.1.1.b0/bin/grads"

web_host="daweb"
web_remote_dir="/home/amemiya/public_html/scale/data/msm_d3"
...
### TORI AEZU 
###    mv $wkdir/out_d3/${prefix}_f${itfcstf}.png $wkdir/out_d3/${prefix}_f${itfcstf}_tmp.png
###    convert  -resize 757x520! $wkdir/out_d3/${prefix}_f${itfcstf}_tmp.png $wkdir/out_d3/${prefix}_f${itfcstf}.png

    rsync  -e "ssh -i /home/amemiya/.ssh/id_rsa_mac" -avz $wkdir/out_d3/${prefix}_f${itfcstf}.png ${web_host}:${web_remote_dir}/${timebasef2}/${prefix}
  ...
  if [ -s "$wkdir/out_d3/${prefix}_f${itfcstf}.eps" ]; then
    ...
    rsync -avz $wkdir/out_d3/${prefix}_f${itfcstf}.eps ${web_host}:${web_remote_dir}/${timebasef2}/${prefix}
