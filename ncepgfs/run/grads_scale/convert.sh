...
echo "wgrib2 bef bashrc" $(which wgrib2)

. /home/amemiya/.bashrc

echo "wgrib2 aft bashrc" $(which wgrib2)

export PATH=/apps/SLES11/opt/grads/2.0.2/bin:$PATH

echo "wgrib2 aft PATH" $(which wgrib2)
...
##### modification for updated GFS format since 2019.6.12 #####
if [ $timef2 -ge 20190612120000 ] && [ $timef2 -lt 20210322120000 ] ;then
