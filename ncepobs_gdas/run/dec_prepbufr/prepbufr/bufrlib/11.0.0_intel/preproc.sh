...
do
  ...
  bnf=${bn}.f
  BNFS="$BNFS $bnf"
  cpp -traditional-cpp -P -C -D$byte_order -DNORMAL_BUILD -DDYNAMIC_ALLOCATION $i $bnf
done
...
cpp -traditional-cpp -P -C -DNORMAL_BUILD -DDYNAMIC_ALLOCATION bufrlib.PRM bufrlib.prm
